...
public class CreateNewDIDDialog extends Dialog {
	...
	/*
	 * final int PHRASES_IN_SEED = 12; protected Combo[] seedPhraseFields = new
	 * Combo[PHRASES_IN_SEED]; //protected String[] phrases = new
	 * String[PHRASES_IN_SEED]; protected List<String> seedPhrases = new
	 * Vector<String>(PHRASES_IN_SEED);
	 */
